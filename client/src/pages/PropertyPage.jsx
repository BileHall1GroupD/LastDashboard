    ...
    >
      ...
      {filteredProperties.length > 0 ? (
        <div className="overflow-x-auto">
          <div className="max-h-80 overflow-y-auto"> {/* Adjusted height to ensure scrolling */}
              ...
              <tbody className="bg-gray-800 divide-y divide-gray-700">
                {filteredProperties.map((property) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{property.square_footage}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{property.bedrooms}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{property.bathrooms}</td>
